...
Test Setup         Navigate to moxfield and sign-in    ${VALID_USERNAME}    ${VALID_PASSWORD}
...
Put a card from your hand onto the battlefield and verify that it stays on the battlefield
    [Documentation]   The purpose of this testcase is to verify that you are able to put a card on the battlefield
    ...     and verify that it stays on there
...    Before using this keyword, ensure that you have navigated to "Your Decks" in Moxfield
...    and opened the desired decklist for adding and removing cards.
...    Explanation of Variables:
...    - ${NAME_OF_THE_DECK}: The name of the decklist you want to work with.
